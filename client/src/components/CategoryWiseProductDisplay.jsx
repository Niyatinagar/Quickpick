...
// const { getRedirectURL } = require("../utils/urlHelper");
...
const CategoryWiseProductDisplay = ({ id, name }) => {
  ...
  // const redirectURL = getRedirectURL(id, name, subCategoryData);
  ...
  return (
    <div className="py-4 bg-gray-50 my-4 rounded-lg">
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between gap-4 mb-4">
        ...
        <Link
          to={redirectURL}
          className="text-green-600 hover:text-green-500 text-sm md:text-base font-medium flex items-center"
        >
          See All
      ...
      <div className="relative">
        <div
          className="flex gap-4 md:gap-5 lg:gap-6 container mx-auto px-4 md:px-6 overflow-x-scroll scrollbar-none scroll-smooth py-2"
          ref={containerRef}
